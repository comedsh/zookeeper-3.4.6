...
public abstract class ClientBase extends ZKTestCase {
	...
	/**
	 * In general don't use this. Only use in the special case that you want to
	 * ignore results (for whatever reason) in your test. Don't use empty
	 * watchers in real code!
	 *
	 */
	...
	public static class CountdownWatcher implements Watcher {
		...
		synchronized public void waitForConnected(long timeout) throws InterruptedException, TimeoutException {
		...
		synchronized public void waitForDisconnected(long timeout) throws InterruptedException, TimeoutException {
			long expire = System.currentTimeMillis() + timeout;
			long left = timeout;
			while (connected && left > 0) {
				wait(left);
	...
	/**
	 * This method instantiates a new server. Starting of the server instance
	 * has been moved to a separate method
	 ...
	 * 
	 * @see <a href="https://issues.apache.org/jira/browse/ZOOKEEPER-1852">
	 *      ZOOKEEPER-1852</a> for more information.
	 */
	...
	public void setUp() throws Exception {
		/*
		 * some useful information - log the number of fds used before and after
		 * a test is run. Helps to verify we are freeing resources correctly.
		 * Unfortunately this only works on unix systems (the only place sun has
		 * implemented as part of the mgmt bean api.
		 */
	...
	public void tearDown() throws Exception {
		...
		// This has to be set to null when the same instance of this class is
		// reused between test cases
		serverFactory = null;
